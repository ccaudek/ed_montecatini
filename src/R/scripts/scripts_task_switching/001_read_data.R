...
GROUP <- "patients" # "patients" "controls"
...
if (GROUP == "patients") {
  saveRDS(df1, here("data", "processed", "task_switching", "patients_task_switching_data.rds"))
} else {
  saveRDS(df1, here("data", "processed", "task_switching", "controls_task_switching_data.rds"))
}
